...
import com.example.devbackend.exception.OAuth2AuthenticationProcessingException;
import com.example.devbackend.model.User;
import com.example.devbackend.repository.UserRepo;
import com.example.devbackend.security.UserPrincipal;
import com.example.devbackend.security.oauth2.user.OAuth2UserInfo;
import com.example.devbackend.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService{
	...
	private OAuth2User processOAuth2User(OAuth2UserRequest userRequest, OAuth2User oAuth2User) {
		...
		if(StringUtils.isEmpty(oAuth2UserInfo.getEmail())) {
			throw new OAuth2AuthenticationProcessingException("Email not found from OAuth Provider");
		}
